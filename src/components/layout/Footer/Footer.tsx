...
function NewsletterSection() {
  return (
    <div className="bg-primary-700 rounded-lg p-6 mb-8">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <input
          ...
          className="flex-1 px-4 py-2 rounded-lg bg-white/10 text-white placeholder-primary-300 border border-primary-600 focus:border-white focus:outline-none transition-colors"
        />
